...
constexpr uint16_t Panel = rgb565(0, 0, 0);
constexpr uint16_t Foreground = rgb565(255, 255, 255);
constexpr uint16_t Muted = rgb565(190, 198, 204);
constexpr uint16_t Red = rgb565(255, 0, 0);
constexpr uint16_t DarkRed = rgb565(180, 0, 0);
