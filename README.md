...
> [!WARNING]
> **LƯU Ý QUAN TRỌNG VỀ PHIÊN BẢN PHẦN CỨNG CYD:**
> Dòng mạch ESP32 Cheap Yellow Display (CYD) trên thị trường có nhiều phiên bản phần cứng và driver màn hình khác nhau (ILI9341 vs ST7789, 1 cổng USB micro vs 2 cổng USB Type-C, ESP32-WROOM vs ESP32-S3). Hãy kiểm tra đúng cấu hình driver bên dưới trước khi flash!

## ⚙️ Cấu hình Driver & Phân biệt Phiên bản

Bảng thông số chi tiết cấu hình driver phần cứng để phân biệt giữa các tree:
